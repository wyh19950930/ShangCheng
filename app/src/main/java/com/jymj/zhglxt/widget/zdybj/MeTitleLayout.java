...
public class MeTitleLayout extends LinearLayout {
    ...
    public MeTitleLayout(Context context) {
        this(context,null);
    }
    public MeTitleLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
        init(context);
        getValues(attrs);
    }
    public MeTitleLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        Log.i("", "init: ");
        ...
        View inflate = inflater.inflate(R.layout.layout_my_title_item, this);
        ll_item_my_title_name = findViewById(R.id.ll_item_my_title_name);
        tv_item_my_title_name = findViewById(R.id.tv_item_my_title_name);//左侧名称
        tv_item_my_title_name_add = findViewById(R.id.tv_item_my_title_name_add);//右侧按钮名称 与图标
        iv_item_my_title_name = findViewById(R.id.iv_item_my_title_name);//右侧展开隐藏箭头
        view_item_my_title_name = findViewById(R.id.view_item_my_title_name);//左侧方块
...
//        Log.i("", "getValues: ");
        ...
        int leftcolor=array.getColor(R.styleable.attrs_info_attr_leftcolor,0);
        ...
        boolean attr_ischeck=array.getBoolean(R.styleable.attrs_info_attr_ischeck,true);
        boolean attr_isleftcheck=array.getBoolean(R.styleable.attrs_info_attr_isleftcheck,true);
...
//                tv_item_my_title_name_add.set(leftsrc,0,0,0);
        ...
        if (leftcolor!=0)
        tv_item_my_title_name_add.setTextColor(leftcolor);
                ...
                ll_item_my_title_name.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (iv_item_my_title_name.getDrawable().getConstantState()
                            ...
                            setImageView(R.drawable.item_title_right);
                        }else {
    ...
    public void setIvVisibility(int isVisibility){
        iv_item_my_title_name.setVisibility(isVisibility);
    }
